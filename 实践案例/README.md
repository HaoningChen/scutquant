...
**教程：**  
[tutorial](https://github.com/HaoningChen/ScutQuant/blob/main/%E5%AE%9E%E8%B7%B5%E6%A1%88%E4%BE%8B/tutorial.ipynb)是一个使用沪深300数据集(日频数据, 训练集时间从2010-01-01到2021-12-31, 测试集时间从2022-01-01至2022-12-24，剔除ST股和涨跌停股，使用后复权价格)构建因子, 并使用hybrid模型预测收益率的例子，要复现它请使用最新版本的scutquant(目前是v0.0.4).  
