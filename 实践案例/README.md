...
**教程：**  
[tutorial](https://github.com/HaoningChen/ScutQuant/blob/main/%E5%AE%9E%E8%B7%B5%E6%A1%88%E4%BE%8B/tutorial.ipynb)是一个使用沪深300数据集(日频数据, 时间从2014-01-01到20021-06-11, 剔除ST股)构建因子, 并使用hybrid模型预测收益率的例子，要复现它请使用最新版本的scutquant(目前是v0.0.6).教程中的策略是: 在T时刻预测T+2对T+1的收益率，并在T+1时刻开仓，T+2自动平仓  
